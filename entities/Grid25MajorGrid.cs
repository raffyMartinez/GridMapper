...
namespace GridMapper.entities
{
    ...
    public class Grid25MajorGrid : IDisposable
    {
        ...
        //private const int SIZING_FACTOR = 9;
        //private const int SIZING_FACTOR = 6;
        private const int SIZING_FACTOR = 8;
        ...
        private Shapefile _gridMajorGridCopy;
        ...
        public const int YBOTTOMBUFFER = 6000;
        ...
        public void FitGridToMap(int WidthToFit = 0, int HeightToFit = 0)
        {
            ...
            if(Grid25LabelManager!=null && Grid25LabelManager.Grid25Labels.NumShapes>0)
            {
                ...
                if(WidthToFit>0 && HeightToFit>0)
                {
                    ...
                    ext.SetBounds(xMin - 1500, yMin - 3000, 0, xMax + 1500, yMax + 3000, 0);
                }
                else
                {
        ...
        /// </summary>
        public void FitGridToMap1(int WidthToFit = 0, int HeightToFit = 0)
        {
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!_disposed)
            {
                ...
                if (_shapefileMajorGrid != null)
                {
                    _shapefileMajorGrid.EditClear();
        ...
        public void GenerateMajorGrids()
        {
            ...
            if (sf.NumShapes > 0)
            {
                ...
                //Grid25Grid = sf;
                sf.SelectAll();
                _gridMajorGridCopy = sf.ExportSelection();
        ...
        public SaveMapParameters SaveMapParameters { get; set; }
        ...
        public void RedoLabels(string mapTitle, Dictionary<string, uint> gridAndLabelProperties, double titleDistanceFactor)
        {
            MapTitle = mapTitle;
        ...
        public bool GenerateMinorGridInsideExtent(Extents definitionExtent, string mapTitle = "")
        {
            ...
            if (_grid25MinorGrid.DefineMinorGrids(_selectedMajorGridShapesExtent, definitionExtent))
            {
                ...
                _grid25MinorGrid.MinorGridLineWidth = (int)LabelAndGridProperties["minorGridThickness"];
