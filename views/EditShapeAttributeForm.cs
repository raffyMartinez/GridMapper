...
namespace GridMapper.views
{
    public partial class EditShapeAttributeForm : Form
    {
        ...
        public static EditShapeAttributeForm GetInstance(MainForm parent, MapInterActionHandler mapInterActionHandler)
        {
            if (_instance == null) _instance = new EditShapeAttributeForm(parent, mapInterActionHandler);
            return _instance;
        }

        public EditShapeAttributeForm(MainForm parent, MapInterActionHandler mapInterActionHandler)
        {
            InitializeComponent();
