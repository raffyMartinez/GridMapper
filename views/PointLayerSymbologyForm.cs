...
namespace GridMapper.views
{
    ...
    public partial class PointLayerSymbologyForm : Form
    {
        ...
        private void OnFormLoad(object sender, EventArgs e)
        {
            ...
            pickerFill.SelectedColorChanged += ApplyOptionsToGUI;
            pickerOutline.SelectedColorChanged += ApplyOptionsToGUI;
        }
        ...
        private void ApplyOptionsToGUI(object sender, EventArgs e)
        {
            ...
            _options.FillColor = Colors.ColorToUInteger(pickerFill.Color);
            _options.LineColor = Colors.ColorToUInteger(pickerOutline.Color);
            ...
            if(sender?.GetType().Name=="Office2007ColorPicker" && ((Owf.Controls.Office2007ColorPicker)sender).Name=="pickerFill")
            {
                characterControl1.ForeColor = pickerFill.Color;
                symbolControl1.ForeColor = pickerFill.Color;
                comboPointType.Color1 = pickerFill.Color;
                transpFillColor.BandColor = pickerFill.Color;
            }
        ...
        private void ShapeDrawOptionsToGUI()
        {
            ...
            pickerFill.Color = Colors.UintToColor(_options.FillColor);
            ...
            pickerOutline.Color = Colors.UintToColor(_options.LineColor);
