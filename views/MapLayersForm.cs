...
namespace GridMapper.views
{
    ...
    public partial class MapLayersForm : Form
    {
        ...
        public MapLayersForm(MapLayersHandler mapLayers, MainForm parent)
        {
            InitializeComponent();
            _parentForm = parent;
        ...
        public static MapLayersForm GetInstance(MapLayersHandler mapLayers, MainForm parent)
        {
        ...
        private void OnMenuLayers_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            {
                case "itemAttributes":
                    var sfa = ShapefileAttributesForm.GetInstance(global.MainForm, global.MainForm.MapInterActionHandler);
                    if (!sfa.Visible)
                    {
                        sfa.Show(this);
                    }
        ...
        private void OnToolbarItemClick(object sender, ToolStripItemClickedEventArgs e)
        {
            switch (e.ClickedItem.Name)
            {
                ...
                case "buttonAttributes":
                    if (_mapLayersHandler.CurrentMapLayer != null)
                    {
                        EditShapeAttributeForm esaf = EditShapeAttributeForm.GetInstance(global.MainForm, global.MainForm.MapInterActionHandler);
                        if (esaf.Visible)
                        {
                            esaf.BringToFront();
                        }
