...
namespace GridMapper.views
{
    ...
    public partial class ShapefileAttributesForm : Form
    {
        ...
        public ShapefileAttributesForm(MainForm parent, MapInterActionHandler mapInterActionHandler)
        {
            InitializeComponent();
        ...
        public static ShapefileAttributesForm GetInstance(MainForm parentForm, MapInterActionHandler mapInterActionHandler)
        {
        ...
        {
            using (EditShapeAttributeForm esaf = new EditShapeAttributeForm(global.MainForm, MapInterActionHandler))
            {
